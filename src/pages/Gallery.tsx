        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-teal-600 text-white py-16 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Gallery X</h1>
                    <p className="text-xl text-blue-100">Explore beautiful properties from our collection</p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    {loading ? (
                        ...
                        <div className="text-center py-20">
                            ...
                            <h2 className="text-2xl font-bold text-gray-700 mb-2">No Images Available</h2>
                            <p className="text-gray-600">Check back soon for property images</p>
                        </div>
                    ) : (
